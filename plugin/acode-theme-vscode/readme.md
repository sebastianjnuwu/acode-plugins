...
<strong>Open source:</strong> Want to see the code? click [here](https://github.com/sebastianjnuwu/acode-plugins/tree/acode/plugin/acode-theme-vscode) and don't forget the little star!
